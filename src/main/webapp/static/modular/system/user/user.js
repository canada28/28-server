...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '商户ID', field: 'id', visible: true, align: 'center', valign: 'middle'},
        {title: '账号', field: 'account', align: 'center', valign: 'middle', sortable: true},
        {title: '姓名', field: 'name', visible: true, align: 'center', valign: 'middle', sortable: true},
        {title: '账单', field: 'bill', align: 'center', valign: 'middle', sortable: true},
        {title: '费率', field: 'rate', align: 'center', valign: 'middle', sortable: true},
        ...
        {title: '部门', field: 'deptName', visible: false, align: 'center', valign: 'middle', sortable: true},
        {title: '邮箱', field: 'email', visible: false, align: 'center', valign: 'middle', sortable: true},
        {title: '电话', field: 'phone', visible: false,  align: 'center', valign: 'middle', sortable: true},
