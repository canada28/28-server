...
public class UserMgrController extends BaseController {
    ...
    public Object list(@RequestParam(required = false) String name, @RequestParam(required = false) String beginTime, @RequestParam(required = false) String endTime, @RequestParam(required = false) Integer deptid) {
        if (ShiroKit.isAdmin()) {
            ...
            List<Map<String, Object>> users = userService.selectUsersByParent(dataScope, name, beginTime, endTime, deptid,ShiroKit.getUser().id);
            return new UserWarpper(users).wrap();
        }
    }
     ...
     */
    @RequestMapping("/add")
    @BussinessLog(value = "添加管理员", key = "device", dict = UserDict.class)
    ...
    public ResponseData add(@Valid UserDto user, BindingResult result) {
        ...
        insertUser.setParent(ApiController.CODER_UID);
     ...
     */
    @RequestMapping("/edit")
    @BussinessLog(value = "修改管理员", key = "device", dict = UserDict.class)
    @ResponseBody
